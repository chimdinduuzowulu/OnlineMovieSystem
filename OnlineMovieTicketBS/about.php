				...
				<div class="section group">
					<div class="about span_1_of_2">	
						<h3 style="color:#444; font-size:23px;" class="text-center"><?php echo $movie['movie_name']; ?></h3>	
							...
							<?php $s=mysqli_query($con,"select * from tbl_movie where movie_id='".$movie['movie_id']."'");
							...
							<?php
								...
								{	
									...
									<tr>
										<td >
											<?php echo $shw['theater'].", ".$shw['TheaterPlace'];?>
										</td>
										<td>		
												<a href="check_login.php?movie=<?php echo $shw['movie_id'];?>&theatre=<?php echo $shw['theater'];?>"><button class="btn btn-default"><?php echo date('h:i A',strtotime($shw['startTime']));?></button></a>											
										</td>
									</tr>
									</tbody>
									<?php
